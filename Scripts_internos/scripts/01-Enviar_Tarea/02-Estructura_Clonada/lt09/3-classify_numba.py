...
def clasifica_multiple(file_uri, num_uri, uris_totales, file_index, line_number_index):
...
#Extraer nombre y extension del ataque
...
if os.environ["LAUNCH_MODE"] == "multiple":
	...
	clasifica_multiple(file_uri, num_uri, uris_totales, file_index, line_number_index)
